            ...
            <div>
                <nav>
                    <ul className="flex items-center gap-8 font-serif">
                        ...
                        <li><a href="#" className="font-normal text-base text-white hover:text-slate-600">Cities</a></li>
                        <li><button className="bg-blue-600 w-28 h-12 rounded-xl"><a href="#" className="font-normal text-base text-white hover:text-slate-600" >👤 Login</a></button></li>
                    </ul>
                </nav>
            </div>
        </header>
